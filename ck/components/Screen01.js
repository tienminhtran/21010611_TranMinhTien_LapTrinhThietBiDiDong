import { Text, SafeAreaView, StyleSheet, StatusBar,Image,View,TouchableOpacity,TextInput } from 'react-native';
...
<Text style ={{fontSize:26, fontWeight:'bold', textAlign:'center', marginBottom:60}}>POWER BIKE {'\n'} SHOP </Text>
    ...
    {/** Button dashboard */}
      <TouchableOpacity style={{width:'100%', backgroundColor:'#E94141', borderRadius:25, marginTop:20}} onPress={() => navigation.navigate('Dashboard')} >
