...
export default function Screen_03({navigation, route}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={{backgroundColor: '#E941411A', width: '100%',height: 388, borderRadius: 16,alignItems: 'center',justifyContent: 'center',  }}>
        <Image source={{ uri: dataBike.img }} style={{ resizeMode: 'contain', width: '80%', height: 330 }} />
      </View>
